<?php //netteCache[01]000377a:2:{s:4:"time";s:21:"0.67454000 1305027858";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:55:"/var/www/nette-box/app/templates/Homepage/default.latte";i:2;i:1305010524;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"b8b94c0 released on 2011-05-10";}}}?><?php

// source file: /var/www/nette-box/app/templates/Homepage/default.latte

?><?php
$_l = Nette\Latte\DefaultMacros::initRuntime($template, NULL, 'ubl9b6s7op'); unset($_extends);


//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb65555cd437_content')) { function _lb65555cd437_content($_l, $_args) { extract($_args)
?>
<div id="wrapper">
	<div id="logo"></div>
	...
	<ol>
		...
		<p>Manage your database using pre-installed tool <a href="<?php echo Nette\Templating\DefaultHelpers::escapeHtml($basePath) ?>/adminer/">Adminer</a> with an easy to use GUI.<p>
	...
	<h2>We hope you enjoy this framework! <img src="<?php echo Nette\Templating\DefaultHelpers::escapeHtml($basePath) ?>/images/nette-powered2.gif" width="80" height="15" alt="Nette Framework powered" /></h2>

	<ul id="environment">
		<li>PHP <?php echo Nette\Templating\DefaultHelpers::escapeHtml(PHP_VERSION) ?></li><?php if (isset($_SERVER['SERVER_SOFTWARE'])): ?>
		<li>Server <?php echo Nette\Templating\DefaultHelpers::escapeHtml($_SERVER['SERVER_SOFTWARE']) ?></li>
<?php endif ?>
		<li>Nette Framework <?php echo Nette\Templating\DefaultHelpers::escapeHtml(Nette\Framework::VERSION) ?></li>
	</ul>
</div>
<?php
}}
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb037fbb5eec_head')) { function _lb037fbb5eec_head($_l, $_args) { extract($_args)
?>
<style>
	html {
